...
and pp_oterm (os:string->unit) (to_pretty_print:bool) = function 
   ...
   |Let (d , pd1 , str2 , pd3 , term4 , pd5 , term6 , pd7 , oterm8) -> print_new_line os to_pretty_print (fst d); print_new_line os to_pretty_print (fst pd1); os "let"; os " " ;print_new_line os to_pretty_print (fst d);  pp_terminal os to_pretty_print str2; os " " ;print_new_line os to_pretty_print (fst d); print_new_line os to_pretty_print (fst pd3); os ":"; os " " ;pp_term os to_pretty_print term4;print_new_line os to_pretty_print (fst d); print_new_line os to_pretty_print (fst pd5); os "="; os " " ;pp_term os to_pretty_print term6;print_new_line os to_pretty_print (fst d); print_new_line os to_pretty_print (fst pd7); os "in"; os " " ;pp_oterm os to_pretty_print oterm8; () 
