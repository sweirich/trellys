...
and pp_cmd (os:string->unit) (to_pretty_print:bool) = function 
   |Def (d , str1 , pd2 , oterm3 , pd4 , oterm5) -> print_new_line os to_pretty_print (fst d);  pp_terminal os to_pretty_print str1; os " " ;print_new_line os to_pretty_print (fst d); print_new_line os to_pretty_print (fst pd2); os ":"; os " " ;pp_oterm os to_pretty_print oterm3;print_new_line os to_pretty_print (fst d); print_new_line os to_pretty_print (fst pd4); os "="; os " " ;pp_oterm os to_pretty_print oterm5; () 
...
and pp_oterm (os:string->unit) (to_pretty_print:bool) = function 
   ...
   |Fix (d , pd1 , binding2 , fix_oterm_comma03 , pd4 , oterm5) -> print_new_line os to_pretty_print (fst d); print_new_line os to_pretty_print (fst pd1); os "fix"; os " " ;pp_binding os to_pretty_print binding2;pp_fix_oterm_comma0 os to_pretty_print fix_oterm_comma03;print_new_line os to_pretty_print (fst d); print_new_line os to_pretty_print (fst pd4); os "in"; os " " ;pp_oterm os to_pretty_print oterm5; () 
...
and pp_prog (os:string->unit) (to_pretty_print:bool) = function 
   |Prog (d , prog_prog_cmd11) -> pp_prog_prog_cmd1 os to_pretty_print prog_prog_cmd11; () 

and pp_term (os:string->unit) (to_pretty_print:bool) = function 
   |App (d , pd1 , term2 , app_term_term23 , pd4) -> print_new_line os to_pretty_print (fst d); print_new_line os to_pretty_print (fst pd1); os "("; os " " ;pp_term os to_pretty_print term2;pp_app_term_term2 os to_pretty_print app_term_term23;print_new_line os to_pretty_print (fst d); print_new_line os to_pretty_print (fst pd4); os ")"; os " " ; () 
...
and pp_trans_term_semi3 (os:string->unit) (to_pretty_print:bool) = function 
   | (d,[]) ->  () 
   | (d , (pd1 , oterm2)::trans_term_semi33) -> print_new_line os to_pretty_print (fst d); print_new_line os to_pretty_print (fst pd1); os ";"; os " " ;pp_oterm os to_pretty_print oterm2;pp_trans_term_semi3 os to_pretty_print  (d,trans_term_semi33); () 

and pp_app_term_term2 (os:string->unit) (to_pretty_print:bool) = function 
   | (d,[]) ->  () 
   | (d , (term1)::app_term_term22) -> pp_term os to_pretty_print term1;pp_app_term_term2 os to_pretty_print  (d,app_term_term22); () 

and pp_prog_prog_cmd1 (os:string->unit) (to_pretty_print:bool) = function 
   | (d,[]) ->  () 
   | (d , (cmd1)::prog_prog_cmd12) -> pp_cmd os to_pretty_print cmd1;pp_prog_prog_cmd1 os to_pretty_print  (d,prog_prog_cmd12); () 

and pp_fix_oterm_comma0 (os:string->unit) (to_pretty_print:bool) = function 
   | (d,[]) ->  () 
   | (d , (pd1 , binding2)::fix_oterm_comma03) -> print_new_line os to_pretty_print (fst d); print_new_line os to_pretty_print (fst pd1); os ","; os " " ;pp_binding os to_pretty_print binding2;pp_fix_oterm_comma0 os to_pretty_print  (d,fix_oterm_comma03); () ;;
