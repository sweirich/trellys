...
and ppast_oterm (os:string->unit) (to_pretty_print:bool) = function 
   ...
   |Let (d , pd1 , str2 , pd3 , term4 , pd5 , term6 , pd7 , oterm8) ->  os "Let"; os "(";print_new_line os to_pretty_print (fst pd1); os "LET("; os "\""; os "let"; os "\")"; os "";os ",";  print_new_line os to_pretty_print (fst d);  pp_terminal os to_pretty_print str2; os "";os ","; print_new_line os to_pretty_print (fst pd3); os "COLON("; os "\""; os ":"; os "\")"; os "";os ","; ppast_term os to_pretty_print term4; os "";os ","; print_new_line os to_pretty_print (fst pd5); os "EQ("; os "\""; os "="; os "\")"; os "";os ","; ppast_term os to_pretty_print term6; os "";os ","; print_new_line os to_pretty_print (fst pd7); os "IN("; os "\""; os "in"; os "\")"; os "";os ","; ppast_oterm os to_pretty_print oterm8; os "";os ")";  () 
